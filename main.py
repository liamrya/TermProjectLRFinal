...
def appStarted(app):
    ...
    app.marioBounds = [187,137,204,157]
...
def timerFired(app):
    ...
    if app.isJumping == True:
        app.marioBounds = [187,app.marioLocation[1]-20,204,app.marioLocation[1]]
    ...
    #     if app.marioBounds[2] > app.barriersDict[i][0]-app.scrollX-5 and app.marioBounds[2] < app.barriersDict[i][0]-app.scrollX:
    #         app.blockR = True
